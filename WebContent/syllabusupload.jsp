...
function validateForm() {
    ...
    var c = document.forms["LoginForm"]["sylldetail"].value;
...
<body>
<center>
        <h1>Upload Syllabus To Database</h1>
		<h3>Files to be uploaded should be in .pdf format and size not above 16MB.</h3>
        <form name="LoginForm" action="SyllabusController" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <table border="0">
                <tr>
                    <td>Upload Syllabus: </td></tr>
					<!-- Selection complete -->
...
<br></td></tr>
<!-- Selection complete -->
					<tr><td>Enter Detail:</td><td><input type="text" name="sylldetail"></td></tr>
